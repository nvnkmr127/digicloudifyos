...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('ad_insights', function (Blueprint $table) {
            ...
            $table->date('date');
            $table->enum('level', ['account', 'campaign', 'adset', 'ad']);
            ...
            $table->decimal('cpc', 18, 4)->default(0);
            $table->decimal('cpm', 18, 4)->default(0);
            $table->decimal('conversions', 18, 4)->default(0);
            $table->decimal('roas', 10, 6)->default(0);
            ...
            $table->index(['ad_account_id', 'date', 'level']);
            $table->unique(['ad_account_id', 'campaign_id', 'ad_set_id', 'ad_id', 'date', 'level'], 'ad_insights_unique_idx');
        });
    }
