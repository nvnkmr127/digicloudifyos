...
return new class extends Migration
{
    ...
    {
        Schema::create('woocommerce_daily_metrics', function (Blueprint $table) {
            ...
            $table->unique(
                ['organization_id', 'client_id', 'metric_date', 'store_url'],
                'woo_daily_unique'
            );
    ...
    {
        Schema::dropIfExists('woocommerce_daily_metrics');
    }
};
