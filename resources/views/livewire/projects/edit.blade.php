<x-app-container>
    ...
    <x-page-header title="Edit Project: {{ $project->name }}" />

    <x-card>
        <form wire:submit="update" class="space-y-6 max-w-4xl">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <x-button color="primary" type="submit">Update Project</x-button>
            </div>
        </form>
    </x-card>
</x-app-container>