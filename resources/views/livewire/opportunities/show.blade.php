    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <x-card class="bg-gradient-to-br from-indigo-900 to-indigo-800 border-0 shadow-lg p-6">
                ...
                <div class="space-y-2">
                    <button class="w-full bg-white/10 hover:bg-white/20 transition px-4 py-3 rounded-xl text-left flex items-center justify-between text-white font-bold text-sm">
                        Mark as Won
