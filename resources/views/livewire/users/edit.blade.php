<x-app-container>
    ...
    <x-card>
        <form wire:submit="update" class="space-y-6 max-w-2xl">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-text-primary">Password (Leave blank to keep
                    current)</label>
                <x-input id="password" type="password" placeholder="New password..." wire:model="password" />
