        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="space-y-4">
                @forelse($alerts as $alert)
                    ...
                    @endphp
                    <div
                        class="{{ $bgColor }} {{ $borderColor }} border rounded-3xl p-6 transition-all hover:shadow-lg hover:shadow-gray-100 flex items-start group">
                        <div
                        ...
                        <div class="flex-grow">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="text-lg font-black tracking-tight {{ $textColor }}">{{ $alert->title }}</h4>
                                <span
                                    class="text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ $alert->triggered_at->diffForHumans() }}</span>
                            </div>
                            <p class="text-sm font-medium text-gray-600 mb-4">{{ $alert->message }}</p>
