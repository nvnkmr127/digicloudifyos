...
<?php endif; ?>
    ...
    <div class="mt-6 flex flex-col gap-3">
        <div class="relative flex items-center">
            ...
            <span class="flex-shrink-0 mx-4 text-gray-400 text-sm">Quick Login</span>
            <div class="flex-grow border-t border-gray-300"></div>
        </div>
        <div class="grid grid-cols-2 gap-3">
            <button type="button"
                onclick="document.getElementById('email').value='admin@example.com'; document.getElementById('password').value='password'; document.forms[0].submit();"
                class="inline-flex items-center justify-center px-4 py-2 bg-white border border-indigo-500 rounded-md font-semibold text-xs text-indigo-700 uppercase tracking-widest shadow-sm hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                Log in as Admin
            </button>
            <button type="button"
                onclick="document.getElementById('email').value='user@example.com'; document.getElementById('password').value='password'; document.forms[0].submit();"
...
<?php endif; ?><?php /**PATH /Users/naveenadicharla/Documents/DC OS/laravel-app/resources/views/auth/login.blade.php ENDPATH**/ ?>