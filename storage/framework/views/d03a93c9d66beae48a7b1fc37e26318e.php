...
<?php $component->withAttributes(['class' => 'bg-blue-50 border-none p-4']); ?>
            ...
            <p class="text-2xl font-bold text-primary mt-2">12</p>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'bg-yellow-50 border-none p-4']); ?>
            ...
            <p class="text-2xl font-bold text-primary mt-2">5</p>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
<?php $attributes = $__attributesOriginal53747ceb358d30c0105769f8471417f6; ?>
...
<?php $component->withAttributes(['class' => 'bg-green-50 border-none p-4']); ?>
            <h4 class="text-sm font-semibold text-text-muted">Signed</h4>
            <p class="text-2xl font-bold text-primary mt-2">34</p>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
<?php $attributes = $__attributesOriginal53747ceb358d30c0105769f8471417f6; ?>
...
<?php $component->withAttributes(['class' => 'bg-red-50 border-none p-4']); ?>
            <h4 class="text-sm font-semibold text-text-muted">Expired</h4>
            <p class="text-2xl font-bold text-primary mt-2">2</p>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
<?php $attributes = $__attributesOriginal53747ceb358d30c0105769f8471417f6; ?>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-text-primary">Q4 Marketing Retainer</span>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">Acme Corp</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span
                            class="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full font-medium">Sent</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">$12,000 / mo</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">Oct 12, 2026</td>
...
<?php endif; ?><?php /**PATH /Users/naveenadicharla/Documents/DC OS/laravel-app/resources/views/livewire/proposals/index.blade.php ENDPATH**/ ?>