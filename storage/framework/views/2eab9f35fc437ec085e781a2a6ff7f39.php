...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary']); ?>Create Report <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary"><?php echo e(number_format($total_clients)); ?></p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary"><?php echo e(number_format($campaigns_count)); ?></p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary"><?php echo e(number_format($projects_count)); ?></p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary">$<?php echo e(number_format($total_revenue, 2)); ?></p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap"><?php echo e($doc->invoice_number); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap"><?php echo e($doc->client->name ?? 'Unknown'); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap"><?php echo e($doc->created_at->diffForHumans()); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <span
                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-<?php echo e(strtolower($doc->status) === 'paid' ? 'green' : (strtolower($doc->status) === 'sent' ? 'yellow' : 'gray')); ?>-100 text-<?php echo e(strtolower($doc->status) === 'paid' ? 'green' : (strtolower($doc->status) === 'sent' ? 'yellow' : 'gray')); ?>-800"><?php echo e(ucfirst($doc->status)); ?></span>
                    </td>
                </tr>
...
<?php endif; ?><?php /**PATH /Users/naveenadicharla/Documents/DC OS/resources/views/livewire/dashboard/index.blade.php ENDPATH**/ ?>