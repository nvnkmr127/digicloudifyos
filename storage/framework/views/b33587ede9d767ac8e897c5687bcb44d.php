<div class="space-y-6">
    <div class="bg-white rounded-lg shadow p-4">
        <div class="flex flex-wrap gap-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sourceFilter !== 'all' || $searchQuery): ?>
                <button 
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex-shrink-0 w-80">
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="px-4 py-3 border-b border-gray-200 <?php echo e($column['color']); ?> rounded-t-lg">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="px-2 py-1 text-xs font-medium bg-white rounded-full">
                                <?php echo e(count($leads[$column['key']] ?? [])); ?>
                    ...
                    >
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leads[$column['key']] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div 
                                class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition cursor-move"
                                draggable="true"
                                @dragstart="handleDragStart($event, '<?php echo e($lead['id']); ?>')"
                            ...
                            >
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead['source']): ?>
                                    <div class="mt-2 pt-2 border-t border-gray-100">
                                        <span class="text-xs text-gray-500">Source: <?php echo e($lead['source']); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
            ...
            return {
                ...
                handleDrop(event, newStatus) {
                    ...
                    if (this.draggedLeadId) {
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').updateLeadStatus(this.draggedLeadId, newStatus);
...
<?php /**PATH /Users/naveenadicharla/Documents/DC OS/resources/views/livewire/leads/kanban-board.blade.php ENDPATH**/ ?>