            ...
            'items' => [
                [
                    ...
                    'children' => [
                        ...
                        ['route' => 'intelligence.briefing', 'label' => 'Daily Briefing'],
                        ['route' => 'intelligence.insights', 'label' => 'AI Insights'],
                        ['route' => 'intelligence.alerts', 'label' => 'Alert Center'],
                    ],
                ],
                [
                    'label' => 'SEO & Health',
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <p class="px-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-2 mt-5"><?php echo e($section['title']); ?></p>
    ...
    <div class="space-y-1">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['route'])): ?>
                <?php if(!$isAllowed($item)) continue; ?>
                ...
                <a href="<?php echo e(route($item['route'])); ?>"
                   ...
                   class="flex items-center px-3 py-2 rounded-element transition-colors duration-150 <?php echo e($active ? 'bg-primary text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'); ?>">
                    <svg class="w-5 h-5 mr-3 <?php echo e($active ? 'text-white' : 'text-gray-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($item['icon']); ?>"></path>
                    </svg>
                    <span class="text-sm font-medium flex-1"><?php echo e($item['label']); ?></span>
                </a>
            <?php else: ?>
                <?php
                ...
                <div x-data="{ open: <?php echo e($childActive ? 'true' : 'false'); ?> }" class="select-none">
                    <button type="button"
                            @click="open = !open"
                            class="w-full flex items-center px-3 py-2 rounded-element transition-colors duration-150 <?php echo e($childActive ? 'bg-gray-100 text-gray-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                        <svg class="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($item['icon']); ?>"></path>
                        </svg>
                        <span class="text-sm font-semibold flex-1 text-left"><?php echo e($item['label']); ?></span>
                    ...
                    <div x-show="open" x-cloak class="mt-1 space-y-1">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $active = $isActiveRoute($child['route']); ?>
                            <a href="<?php echo e(route($child['route'])); ?>"
                               wire:navigate
                               <?php echo e($active ? 'aria-current=page' : ''); ?>

                               class="flex items-center pl-11 pr-3 py-2 rounded-element transition-colors duration-150 <?php echo e($active ? 'bg-primary text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100'); ?>">
                                <span class="text-sm font-medium flex-1"><?php echo e($child['label']); ?></span>
                            </a>
