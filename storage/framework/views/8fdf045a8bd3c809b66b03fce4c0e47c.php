...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary">1,245</p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary">84</p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm font-medium text-text-muted">Orders</p>
                    <p class="text-2xl font-semibold text-text-primary">432</p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-primary">$12,450</p>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">Created a new product</td>
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">Deleted an order</td>
                <td class="px-6 py-4 whitespace-nowrap">John Smith</td>
                <td class="px-6 py-4 whitespace-nowrap">5 hours ago</td>
                <td class="px-6 py-4 whitespace-nowrap text-right">
                    <span
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">Updated user settings</td>
                <td class="px-6 py-4 whitespace-nowrap">Michael Brown</td>
                <td class="px-6 py-4 whitespace-nowrap">Yesterday</td>
                <td class="px-6 py-4 whitespace-nowrap text-right">
                    <span
                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Success</span>
                </td>
...
<?php endif; ?><?php /**PATH /Users/naveenadicharla/Documents/DC OS/laravel-app/resources/views/livewire/dashboard/index.blade.php ENDPATH**/ ?>