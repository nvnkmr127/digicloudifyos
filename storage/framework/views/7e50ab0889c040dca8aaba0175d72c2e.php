...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Orders']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'search','placeholder' => 'Search orders by ID or customer...','class' => 'max-w-md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'search','placeholder' => 'Search orders by ID or customer...','class' => 'max-w-md']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['class' => 'max-w-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [1001, 1002, 1003, 1004]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap font-medium text-text-primary">
                        #ORD-<?php echo e($order); ?>

                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-text-muted">
                        Acme Corp Customer <?php echo e($order); ?>

                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-text-muted">
                        <?php echo e(now()->subDays($order % 5)->format('M d, Y')); ?>

                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order % 3 == 0): ?>
                            <span
                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">Processing</span>
                        <?php elseif($order % 2 == 0): ?>
                            <span
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-text-primary font-medium">
                        $<?php echo e(number_format($order * 1.5, 2)); ?>

                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="<?php echo e(route('orders.show', $order)); ?>" wire:navigate
...
<?php endif; ?><?php /**PATH /Users/naveenadicharla/Documents/DC OS/laravel-app/resources/views/livewire/orders/index.blade.php ENDPATH**/ ?>