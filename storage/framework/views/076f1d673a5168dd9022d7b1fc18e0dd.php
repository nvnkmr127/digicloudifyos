...
<?php endif; ?>
    ...
    <div class="mt-8 pt-6 border-t border-gray-100">
        <p class="text-xs text-center text-gray-500 mb-4 uppercase tracking-widest font-semibold">Quick Access
            (Auto-Login)</p>
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['OWNER', 'ADMIN', 'ANALYST', 'OPERATOR', 'VIEWER']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('auto-login', ['role' => strtolower($role)])); ?>"
                    class="inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
                    <?php echo e($role); ?>
...
<?php endif; ?><?php /**PATH /Users/naveenadicharla/Documents/DC OS/resources/views/auth/login.blade.php ENDPATH**/ ?>